...
namespace DotNetBcBackend.Migrations
{
    ...
    [Migration("20170410154757_SecondMigration")]
    partial class SecondMigration
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("DotNetBcBackend.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("DotNetBcBackend.Models.UserEvents", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.EntityFrameworkCore.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("DotNetBcBackend.Models.ApplicationUser")
                        .WithMany("Claims")
